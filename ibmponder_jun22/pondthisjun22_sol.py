'''
IBM Ponder This challenge and bonus *, June 22
https://research.ibm.com/haifa/ponderthis/challenges/June2022.html
Sanandan Swaminathan, submitted June 6, 2022

My answer for the main question of the June 2022 IBM Ponder This challenge (sequence of number of odd fixed polyominoes for n = 1 through n = 18) is:

0, 1, 3, 11, 35, 108, 380, 1348, 5014, 18223, 67634, 252849, 950346, 3602437, 13697333, 52293534, 200399576, 770410271

For bonus *...
0, 1, 3, 11, 35, 108, 380, 1348, 5014, 18223, 67634, 252849, 950346, 3602437, 13697333, 52293534, 200399576, 770410271, 2970369338, 11482572252

As a side note, the sequence I got for number of fixed polyominoes (total of odd and even) from n = 1 through n = 20 is:
1, 2, 6, 19, 63, 216, 760, 2725, 9910, 36446, 135268, 505861, 1903890, 7204874, 27394666, 104592937, 400795844, 1540820542, 5940738676, 22964779660

My program basically works like the Redelmeier recursive, depth-first search for enumerating polyominoes and avoiding duplicates. Apart from having counters for fixed and odd, fixed polyominoes, I also have a counter to keep track of the total number of inversions needed to take a polyomino from one sort order to the other. When a cell gets added to the current polyomino, I compute the number of inversions this cell would need with all the other existing cells to go from one sort order to the other. This number gets added to the total inversions counter for this polyomino. If the total inversion count for the polyomino so far has odd parity, then this polyomino with the new cell added is another odd polyomino of that size.

While it's not surprising that the number of odd fixed polyominoes hovers around the 50% mark, it was nice to see several sizes where the split is exactly 50-50 between odd and even fixed polyominoes, including n = 18 !
